  ...
  THEME.Video = (function () {
    ...
    function onPlayerChange(evt) {
      ...
      if (
        ...
        (evt.data === YT.PlayerState.PLAYING || evt.data === YT.PlayerState.BUFFERING)
      ) {
  ...
  THEME.initialization = {
        ...
        var MainSlider = {
          ...
          _animate: function _animate() {
            ...
            $slider.on("afterChange", function (e, slick) {
              ...
              var $currentSlide = slick.find(".slick-current"),
                status =
                  ($currentSlide.data("autoplay") == true && !$currentSlide.hasClass("is-custom-paused")) ||
            ...
            function keepScale(slider) {
              ...
              if ($bnsliderNoScale.hasClass("keep-scale") && !$bnsliderNoScale.hasClass("bnslider--fullheight")) {
                ...
                if (
                  ...
                  var bnrH =
                    (parseInt($bnsliderNoScale.attr("data-start-mheight"), 10) / parseInt($bnsliderNoScale.attr("data-start-mwidth"), 10)) * wW;
                  $bnsliderNoScale.css({
                    height: bnrH + "px",
                    "min-height": bnrH + "px",
                  });
                  ...
                  var bnrH =
                    (parseInt($bnsliderNoScale.attr("data-start-height"), 10) / parseInt($bnsliderNoScale.attr("data-start-width"), 10)) * wW;
                  if ($bnsliderNoScale.closest("div[class^='col-'],div[class*=' col-']").length) {
                    var colW = ($bnsliderNoScale.closest("div[class^='col-'],div[class*=' col-']").width() * 100) / wW;
                    bnrH = (bnrH * colW) / 100;
                  } else if ($bnsliderNoScale.closest(".holder.boxed").length) {
          ...
          function s(t) {
            ...
            return {
              ...
              color:
                ...
                { r: a(o.substring(0, 2)), g: a(o.substring(2, 4)), b: a(o.substring(4, 6)) }),
              tick: 0,
              totalTicks: t.ticks,
              decay: t.decay,
          ...
          (e.exports = function (t) {
            for (
              var e,
                ...
                b = l(t, "ticks", Number),
                y = l(t, "zIndex", Number),
                g = (((e = l(t, "origin", Object)).x = l(e, "x", Number)), (e.y = l(e, "y", Number)), e),
                M = r,
                p = [],
                x = o
                  ? o.canvas
    ...
    openAccordion: function openAccordion(accordion) {
      ...
      $(accordion)
        ...
        .promise()
        .done($(accordion).find(".panel:first-child").find(".panel-title > a").trigger("click"));
    },
      ...
      THEME.megamenu = {
        ...
        _handlers: function _handlers(menu) {
          function setMaxHeight(wHeight, submenu) {
            ...
            if (submenu.length) {
              var maxH = $body.hasClass("has-sticky")
                ...
                : wHeight - submenu.prev().offset().top - submenu.prev().outerHeight();
          ...
          var $menu = $(menu.defaults.menu),
            ...
            timer = void 0;
          $menu
            .on("mouseenter.mmenu", megaDropdnClass + "> a," + simpleDropdnClass + "> a", function () {
              var $this = $(this);
      ...
      var ProductPageGallery = {
        ...
        _handlers: function _handlers() {
          var that = this,
            ...
            slidesToShow =
              $previews.closest(that.defaults.doubleSelector).length && $previews.closest(that.defaults.verticalSelector).length
                ? 3
                : $previews.closest(that.defaults.verticalSelector).length
                ? 6
                : 4,
            slidesToShowT = $previews.closest(that.defaults.doubleSelector).length
              ? slidesToShow
              : $previews.closest(that.defaults.verticalSelector).length
              ? slidesToShow - 1
              : slidesToShow;
    ...
    slickCarousels: function slickCarousels() {
      ...
      if ($(".js-prd-carousel-vert-2").length) {
        $(".js-prd-carousel-vert-2").each(function () {
          var $this = $(this);
          if ($this.hasClass("slick-initialized")) return false;
          var arrowsplace = $this.parent().parent().find(".js-prd-carousel-vert-arrows").length
